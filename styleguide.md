...
* Include sections to achieve the goal, with steps for each task (numbered steps, clear directions, and correct UI workflow)
	For an example, see [Sending a Campaign]({{root_url}}/knowledge-center/sending-email/how-to-send-email/)
...
Here is an example "Additional Resources" section: https://sendgrid.com/docs/knowledge-center/sending-email/editor/#additional-resources
