...
![](https://github.com/Whatthefoxsays/docs/blob/github-cheatsheet/source/img/docs_view_and_edit.png =500x)
...
![](https://github.com/Whatthefoxsays/docs/blob/github-cheatsheet/source/img/docs_signup.png =500x)

Once you are viewing a Docs page in GitHub, simply click the pencil icon to begin editing:

![](https://github.com/Whatthefoxsays/docs/blob/github-cheatsheet/source/img/docs_edit_github.png =500x)
