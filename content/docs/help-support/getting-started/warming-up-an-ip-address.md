...
{% anchor h2 %}	What is warming up an IP?
{% endanchor %}	
...
{% anchor h3 %}	Manually warm up your IP
{% endanchor %}	
...
{% anchor h3 %}	Automated IP warmup API
{% endanchor %}	
...
{% anchor h3 %}	Automated IP warmup hourly send schedule
{% endanchor %}	
...
{% anchor h2 %}	Why don't other ESPs require IP warmup?
{% endanchor %}	
