...
After uploading contacts, you can define segments for individual contacts or lists based on specified criteria. For more information, see [Segmentating your contacts]({{root_url}}/help-support/managing-contacts/segmenting-your-contacts/).
