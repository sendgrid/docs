...
The instructions also assume that you have set up a valid [branded link](https://sendgrid.com/docs/help-support/getting-started/how-to-set-up-link-branding/) on your account. This step is essential for the following instructions to work.
