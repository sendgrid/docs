...
The total message size of emails sent via the [v3 mail send endpoint](https://sendgrid.com/docs/Web_API_v3/Mail/index.html) is limited to 30MB. This includes all headers, the body, and attachments. That means
...
The total message size of emails sent via the [v2 mail send endpoint](https://sendgrid.com/docs/Web_API/mail.html) is limited to 20,480,000 bytes, or approximately
...
To send emails with attachments via SendGrid, you can employ our [SMTP Relay]({{root_url}}/glossary/smtp-relay) or our [Web API v3](https://sendgrid.com/docs/Web_API_v3/Mail/index/).
