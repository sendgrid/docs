...
API Keys are used to authenticate API calls. Just as a teammate can be given specific permissions, API keys can be assigned specific [permissions](https://sendgrid.com/docs/Web_API_v3/API_Keys/api_key_permissions_list/) to restrict which API calls they can authenticate.
...
* [API Reference](https://sendgrid.com/docs/Web_API_v3/teammates/)
