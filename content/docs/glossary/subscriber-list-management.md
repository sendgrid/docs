...
Make sure to check your list stats. You can do this in [Marketing Campaigns]({{root_url}}/ui/sending-email/how-to-send-email/) by clicking on the stats button next to your recipient list name. You can also [manage your unsubscribes]({{root_url}}/ui/sending-email/index-suppressions/) by clicking the manage unsubscribes button next to your recipient list name.
