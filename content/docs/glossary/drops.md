...
We recommend Using the [Web API]({{root_url}}/API_Reference/Web_API/index/) to export any of the suppression lists. Once you export that data, you can use it to clean your distribution lists.
