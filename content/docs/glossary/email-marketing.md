...
* [Pre-designed email templates]({{root_url}}/user-interface/sending-email/working-with-marketing-templates/)
* [Importing Custom HTML With Drag & Drop Markup]({{root_url}}/user-interface/sending-email/editor/#importing-custom-html-with-drag--drop-markup)
* [Ability to use your own HTML]({{root_url}}/user-interface/sending-email/editor/)
* [Scheduled Marketing campaigns delivery]({{root_url}}/API_Reference/Web_API_v3/Marketing_Campaigns/campaigns.html)
* [Powerful analytics]({{root_url}}/user-interface/analytics-and-reporting/stats-overview/)
* [A/B testing]({{root_url}}/user-interface/sending-email/a-b-testing/)
* [List Segmentation]({{root_url}}/user-interface/managing-contacts/segmenting-your-contacts/)
