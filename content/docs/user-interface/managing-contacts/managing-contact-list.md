...
In your SendGrid Account there are different [Suppressions]({{root_url}}/user-interface/sending-email/index-suppressions/) lists.
...
- [Segmentation]({{root_url}}/user-interface/managing-contacts/segmenting-your-contacts/)
- [Unsubscribe Groups]({{root_url}}/user-interface/sending-email/index-suppressions/)
- [Custom Fields]({{root_url}}/user-interface/sending-email/custom-fields/)
