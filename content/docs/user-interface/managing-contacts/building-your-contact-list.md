...
- [Lists and Segmentation]({{root_url}}/user-interface/managing-contacts/segmenting-your-contacts/)
- [Unsubscribe Groups]({{root_url}}/docs/user-interface/sending-email/index-suppressions/)
