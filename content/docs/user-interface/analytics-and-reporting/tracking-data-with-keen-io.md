...
The SendGrid [Event Webhook]({{root_url}}/for-developers/tracking-events/event/) lets you stream all [email events]({{root_url}}/user-interface/analytics-and-reporting/email-activity-feed/) directly to Keen IO for real-time analysis and long term raw storage.
