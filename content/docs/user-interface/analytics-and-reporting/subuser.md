...
Subusers can help organize your email sending and analytics by enabling you to segment by a different sender and IP address. Just as you can view the statistics on all your [email activity]({{root_url}}/user-interface/analytics-and-reporting/email-activity-feed/), you can go a step further and view the statistics broken down to a particular subuser.
...
- [Email Activity]({{root_url}}/user-interface/analytics-and-reporting/email-activity-feed/)
