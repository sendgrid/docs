...
For more information about understanding your bill, see [Reading your invoice]({{root_url}}/user-interface/account-and-settings/reading-your-invoice/).
...
- [Reading your invoice]({{root_url}}/user-interface/account-and-settings/reading-your-invoice/)
