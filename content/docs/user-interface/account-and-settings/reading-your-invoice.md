...
If you are in [a jurisdiction that SendGrid is required to charge sales tax]({{root_url}}/user-interface/account-and-settings/taxes-and-tax-exempt/), here is your tax summary:
