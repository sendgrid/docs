...
1. Open a new template in the [Code Editor]({{root_url}}/user-interface/sending-email/editor/#the-code-editor) or [Design Editor]({{root_url}}/user-interface/sending-email/editor/#the-design-editor) by clicking **Actions** and selecting **New Version**.
...
For more information about unsubscribes, check out our [unsubscribe documentation]({{root_url}}/user-interface/sending-email/index-suppressions/).



## Additional Resources

- [Dynamic Templates]({{root_url}}/user-interface/sending-email/how-to-send-an-email-with-dynamic-transactional-teplates/)
- [Using Handlebars]({{root_url}}/user-interface/sending-email/using-handlebars/)
- [Design & Code Editor]({{root_url}}/user-interface/sending-email/editor/)
