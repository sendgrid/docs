...
You can also put your IP address into warmup mode with our [Automated Warmup API]({{root_url}}/user-interface/sending-email/warming-up-an-ip-address/) - this automatically throttles traffic sent through your new IP according to our [warm up schedule](https://sendgrid.com/docs/API_Reference/Web_API_v3/IP_Management/ip_warmup_schedule.html).
...
- [Adding a dedicated IP]({{root_url}}/user-interface/account-and-settings/dedicated-ip-addresses/)
