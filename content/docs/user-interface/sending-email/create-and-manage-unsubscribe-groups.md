...
From the UI, you can edit Unsubscribe Groups or download a list of recipients that have unsubscribed from your emails. For more information on managing unsubscribes, see the SendGrid [Suppressions Overview]({{root_url}}/user-interface/sending-email/index-suppressions/#managing-unsubscribes)
...
- [Suppressions Overview]({{root_url}}/user-interface/sending-email/index-suppressions/)
