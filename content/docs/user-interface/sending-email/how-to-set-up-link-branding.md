...
We suggest [CloudFlare]({{root_url}}/user-interface/sending-email/content-delivery-networks/#using-cloudFflare), [Fastly]({{root_url}}/user-interface/sending-email/content-delivery-networks/#using-fastly), or [KeyCDN]({{root_url}}/user-interface/sending-email/content-delivery-networks/#using-keycdn) when using Content Delivery Networks with SendGrid.
