...
If you have an [authenticated domain]({{root_url}}/user-interface/sending-email/how-to-set-up-domain-authentication/) and your sender email address matches that domain exactly, your sender identity will automatically verify.
