...
{% anchor h2 %}	Point and Click Setup in Windows Azure
{% endanchor %}	
...
{% anchor h2 %}	Connect to the SendGrid Inbound Parse API
{% endanchor %}	
...
{% anchor h2 %}	Prepare the Code to Run on Windows Azure
{% endanchor%}	
...
{% anchor h2 %}	Add a Backend Using Windows Mobile Services
{% endanchor %}	
...
{% anchor h2 %}	Connect Windows Azure Mobile Services to iOS
{% endanchor %}	
