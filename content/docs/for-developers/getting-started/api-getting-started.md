...
{% anchor h2 %}	How to send an API email
{% endanchor %}	
{% anchor h3 %}	Build your API call
{% endanchor %}	
...
{% anchor h3 %}	Send your email using the API
{% endanchor %}	
...
{% anchor h3 %}	API Response messages
{% endanchor %}	
