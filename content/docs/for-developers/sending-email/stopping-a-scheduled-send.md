...
{% anchor h2 %}	Canceling Transactional Email
{% endanchor %}	
{% anchor h3 %}	Cancel Scheduled Sends
{% endanchor %}	
...
{% anchor h4 %}	1. Generate a Batch ID
{% endanchor %}	
...
{% anchor h4 %}	2. Assign Batch ID to an Email
{% endanchor %}	
...
{% anchor h4 %}	3. Cancel or Pause Your Send
{% endanchor %}	
...
{% anchor h2 %}	Canceling a Marketing Campaign
{% endanchor %}	
{% anchor h3 %}	Using the User Interface
{% endanchor %}	
