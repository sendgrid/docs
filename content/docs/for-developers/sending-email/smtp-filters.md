...
For more information on the utility of these settings, please check out the [Settings]({{root_url}}/user-interface/account-and-settings/account/) section.
...
<td>url</td>
<td><code>url</code></td>
<td>an optional url to POST the email and a copy of the report to. Refer to the <a href="{{root_url}}/user-interface/account-and-settings/mail/#spam-checker">Spam Checker documentation</a> for POST details.</td>
</tr>
</tbody>
</table>
