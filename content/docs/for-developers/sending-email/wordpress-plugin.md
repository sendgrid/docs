...
navigation:
 show: true
---
{% anchor h2 %}	What is the SendGrid WordPress Plugin?
{% endanchor %}	
...
{% anchor h2 %}	Installing SendGrid’s WordPress Plugin
{% endanchor %}	
...
{% anchor h2 %}	Configuring SendGrid’s WordPress Plugin
{% endanchor %}	
...
{% anchor h3 %}	The wp_mail() Function
{% endanchor %}	
...
{% anchor h2 %}	Sending HTML In Your Email Using Different Headers
{% endanchor %}	
{% anchor h3 %}	Using an Array to Set Your Headers
{% endanchor %}	
```php
...
{% anchor h3 %}	Using SendGrid\Email() to Set Your Headers
{% endanchor %}	
```php
$subject = 'Test SendGrid plugin';
$message = 'testing WordPress plugin';
...
{% anchor h2 %}	Substitution Tags and Sections
{% endanchor %}	
```php
...
{% anchor h2 %}	How to Use Categories
{% endanchor %}	
...
{% endanchor %}	* [SendGrid's WordPress Subscription Widget]({{root_url}}/for-developers/managing-contacts/wordpress-subscription-widget.html)
