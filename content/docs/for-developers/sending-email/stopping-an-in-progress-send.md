...
{% anchor h2 %}	Stopping Transactional Email
{% endanchor %}	
...
{% anchor h3 %}	1. Change Your Password
{% endanchor %}	
...
{% anchor h2 %}	Stopping a Marketing Campaign
{% endanchor %}	
...
{% anchor h3 %}	Using the SendGrid API
{% endanchor %}	
