...
You can delete a campaign by making a call to [/v3/campaigns/{campaign_id}](https://sendgrid.com/docs/Web_API_v3/Marketing_Campaigns/campaigns.html#Delete-a-Campaign-DELETE) where `{campaign_id}` is the ID of the campaign you want to stop. A successful deletion will return a 204.
