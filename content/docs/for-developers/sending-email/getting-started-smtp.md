...
You can also send email with [the UI]({{root_url}}/knowledge-center/sending-email/how-to-send-email/) and with [the API]({{root_url}}/api-reference/).
...
- [Getting Started with the UI]({{root_url}}/knowledge-center/sending-email/how-to-send-email/)
