...
2. Create an [API Key]({{root_url}}/user-interface/account-and-settings/api-keys/).
...
* An [API Key]({{root_url}}/user-interface/account-and-settings/api-keys/) within the Authorization Header
...
If you have not yet set up [Sender Authentication]({{root_url}}/user-interface/sending-email/how-to-set-up-domain-authentication/) in your account, you may need to check your spam folder for the email you just sent.
...
- [How to Send Email]({{root_url}}/user-interface/sending-email/how-to-send-email/)
