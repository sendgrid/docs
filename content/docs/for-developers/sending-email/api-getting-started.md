...
2. Create an [API Key]({{root_url}}/knowledge-center/account-and-settings/api-keys/).
...
* An [API Key]({{root_url}}/knowledge-center/account-and-settings/api-keys/) within the Authorization Header
...
If you have not yet set up [Sender Authentication]({{root_url}}/knowledge-center/sending-email/how-to-set-up-domain-authentication/) in your account, you may need to check your spam folder for the email you just sent.
...
- [Sender Authentication]({{root_url}}/knowledge-center/sending-email/how-to-set-up-domain-authentication/)
- [How to Send Email]({{root_url}}/knowledge-center/sending-email/how-to-send-email/)
