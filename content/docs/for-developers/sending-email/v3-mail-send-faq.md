...
There are rate limits on how frequently you can call the v3 Mail Send endpoint. Currently, our platform is capable of making up to 30,000 requests per second to our endpoint. Each email you send may include up to 1000 recipients. For more information on other limitations, and how this may impact your integration, please visit our [v3 Mail Send overview]({{root_url}}/API_Reference/Web_API_v3/Mail/index.html).
