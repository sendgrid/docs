...
{% anchor h2 %}	What is the v3 Mail Send endpoint?
{% endanchor %}	
...
{% anchor h2 %}	Do I have to have a certain type of account to use the v3 Mail Send endpoint?
{% endanchor %}	
...
{% anchor h2 %}	I’m currently using the v2 Mail Send endpoint. Should I switch to v3?
{% endanchor %}	
...
{% anchor h2 %}	How do I migrate from V2 to V3?
{% endanchor %}	
...
{% anchor h2 %}	What’s the difference between sending mail via SMTP and the Web API?
{% endanchor %}	
...
{% anchor h2 %}	Can I send marketing email over the v3 Mail Send endpoint?
{% endanchor %}	
...
{% anchor h2 %}	Are there limits on how often I can send email and how many recipients I can send to?
{% endanchor %}	
...
{% anchor h2 %}	Why did you remove the x-smtpapi parameter? Can I still change my mail settings, tracking settings, and unique arguments?
{% endanchor %}	
...
{% anchor h2 %}	Where can I find more information about the v3 Mail Send endpoint?
{% endanchor %}	
