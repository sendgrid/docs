...
<br> To create a campaign from an existing one, find the version you want to use, hover over the **action menu** to the far right of the campaign, and then select **Duplicate**.<br>
