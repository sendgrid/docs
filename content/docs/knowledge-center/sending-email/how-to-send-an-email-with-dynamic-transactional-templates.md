...
* Create an [API Key]({{root_url}}/knowledge-center/account-and-settings/api-keys/)
* Add an [unsubscribe group]({{root_url}}/knowledge-center/sending-email/group-unsubscribes/) (optional)
...
5. Design your template. For more information on using Handlebars, see [Using handlebars]({{root_url}}/knowledge-center/sending-email/using-handlebars/).
...
- [Unsubscribe Groups]({{root_url}}/knowledge-center/sending-email/group-unsubscribes/)
