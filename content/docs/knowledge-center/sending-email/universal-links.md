...
- You must complete the [link branding process]({{root_url}}/knowledge-center/sending-email/how-to-set-up-link-branding/) for your account. When branding your links, you must use the same domain that will be used for your universal links. (e.g. links.example.com)
