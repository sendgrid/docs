...
- [Design Editor]({{root_url}}/knowledge-center/sending-email/editor/#the-design-editor)
- [Code Editor]({{root_url}}/knowledge-center/sending-email/editor/#the-code-editor)
