...
In your SendGrid Account there are different [Suppressions]({{root_url}}/knowledge-center/sending-email/index-suppressions/) lists.
...
- [Segmentation]({{root_url}}/knowledge-center/managing-contacts/segmenting-your-contacts/)
- [Unsubscribe Groups]({{root_url}}/knowledge-center/sending-email/index-suppressions/)
- [Custom Fields]({{root_url}}/knowledge-center/sending-email/custom-fields/)
