...
You may have at some point shared your credentials with someone else/another department, check with them to make sure they haven't changed anything. Also consider implementing [Teammates]({{root_url}}/knowledge-center/account-and-settings/teammates/) to set different levels of permissions.
...
We don't have a strict username syntax policy, so it may be something you wouldn't normally use. Read more about finding and recovering your username [here]({{root_url}}/knowledge-center/account-and-settings/resetting-your-username-and-password/).
