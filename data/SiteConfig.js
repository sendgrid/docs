module.exports = {
  ...
  pathPrefix: '/docs',
  siteDescription: 'Learn how to get started using SendGrid. Integrate in minutes, free testing, and get access to documents to help solve your email deliverability problems.',
  siteRss: '/rss.xml',
