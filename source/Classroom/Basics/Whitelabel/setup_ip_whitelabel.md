...
{% info %}
Only the parent account or a Teammate the Whitelabel permission can create IP whitelabels, however the parent account can assign the whitelabeled IP to subusers.
{% endinfo %}
