...
The instructions also assume that you have setup a validated [Email Links Whitelabel](https://sendgrid.com/docs/User_Guide/Settings/Whitelabel/links.html) on your account. This step is essential for the following instructions to work appropriately.
