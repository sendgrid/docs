...
This functionality can be replicated using SendGrid's [SMTPAPI]({{root_url}}/API_Reference/SMTP_API/index.html), using [Substitution Tags]({{root_url}}/API_Reference/SMTP_API/substitution_tags.html) and [Custom Fields]({{root_url}}/User_Guide/Marketing_Campaigns/custom_fields.html) in [Marketing Campaigns]({{root_url}}/User_Guide/Marketing_Campaigns/contacts.html) for marketing emails and our [transactional templates application]({{root_url}}/API_Reference/Web_API_v3/Template_Engine/smtpapi.html) for transactional emails.
