...
{% parameters eventnotify %}
 ...
 {% parameter 'group_unsubscribe' 'Yes' 'Notify when email unsubscribes from an [Unsubscribe Group Group]({{root_url}}//API_Reference/Web_API_v3/Suppression_Management/groups.html)' '1' %}
