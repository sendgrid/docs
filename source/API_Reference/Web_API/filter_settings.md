...
{% parameters subscriptiontrack %}
 ...
 {% parameter 'text/html' 'No' 'String for the HTML email body' 'If you would like to unsubscribe and stop receiving these emails &lt;% click here %&gt;' %}
 {% parameter 'text/plain' 'No' 'String for the plain text email body' 'If you would like to unsubscribe and stop receiving these emails click here: &lt;% %&gt;.' %}
