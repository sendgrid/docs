...
If there are no existing warm IPs, you will need to manually warmup the IP by using our [IP Warmup Guide](https://sendgrid.com/docs/assets/IPWarmupSchedule.pdf).
