...
<div class="row">
  <div class="clearfix col-md-6">
    <h3>
      <a href="{{root_url}}/API_Reference/Web_API_v3/Transactional_Templates/index.html">Integrate With Your App</a>
    </h3>

    <p>The Authy App allows you to authenticate over WiFi if you do not have cellular service. However, you may still resort to an SMS message as a backup if you decide to use Authy.</p>
  </div>
  <div class="col-md-6">
...
<div class="row">
  <div class="clearfix col-md-6">
    ...
    <p><strong>When authenticating via SMS message, you must have cellular service or you will not be able to log into your account.</strong> </p>
  </div>
  <div class="col-md-6">
...
<div class="row">
  <div class="clearfix col-md-6">
    ...
    <p>You will then be shown a window in which to enter a 7-digit authentication token sent to your mobile phone via text message or generated by your Authy App.</p>

    <p>Enter this token to confirm that you may delete this setting, then click <strong>Delete</strong>.</p>
  </div>
  <div class="col-md-6">
