...
1. Design your template. For more information on designing a Dynamic Transactional Template using the Design Editor or Code Editor, see the [documenation]({{root_url}}/User_Guide/Transactional)Templates/create_and_edit_dynamic_transactional_templates.html).
