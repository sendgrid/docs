...
1. Design your template. For more information on using Handlebars, see [Create and edit Dynamic Transactional Templates]({{root_url}}/User_Guide/Transactional_Templates/Using_handlebars.html).
