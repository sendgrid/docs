...
{% anchor h2 %} General Formatting Rules {% endanchor %}
...
{% anchor h3 %} Contact Info {% endanchor %}
...
{% anchor h3 %} Header Row {% endanchor %}
...
{% anchor h3 %} Character Encoding {% endanchor %}
...
{% anchor h3 %} Date Formatting {% endanchor %}
...
{% anchor h3 %} I have more than one of the same email in my database {% endanchor %}
