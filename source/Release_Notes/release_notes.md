...
<table class="table" style="width: 100%;">
  <tr>
    <td><img src="{{root_url}}/images/ui_icon.png" alt="An update to the UI" width="150" height="150"></td>
...
<table class="table" style="width: 100%;">
  <tr>
    <td><img src="{{root_url}}/images/partners_icon.png" alt="An update to one of our Partners" width="150" height="150"></td>
...
<table class="table" style="width: 100%;">
  <tr>
    <td><img src="{{root_url}}/images/pricing_icon.png" alt="An update to the price" width="150" height="150"></td>
...
<table class="table" style="width: 100%;">
  <tr>
    <td><img src="{{root_url}}/images/code_icon.png" alt="An update to the API" width="150" height="150"></td>
