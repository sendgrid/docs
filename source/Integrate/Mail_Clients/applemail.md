...
![Mail, Preferences, Outgoing Mail Server (SMTP) dropdown, Edit SMTP Server List]({{root_url}}/images/NewAppleMail_1.png "Edit SMTP Server List")

Next click the **+** under the list of SMTP servers, and add a new one.

![The plus button to click to add an SMTP server]({{root_url}}/images/NewAppleMail_2.png "Add SMTP Server")
...
![Settings for Mail to use SendGrid SMTP]({{root_url}}/images/NewAppleMail_3.png "SendGrid SMTP server settings")
...
![The dropdown menu to select the SMTP server to use for this send.]({{root_url}}/images/NewAppleMail_4.png "SMTP server dropdown")
